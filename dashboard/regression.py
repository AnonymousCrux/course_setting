...
def show_regression(df):
    ...
    st.sidebar.text(
        '1 = Davos / 2 = Diavolezza / 3 = Grindelwald / 4 = Kreuzbergpass / 5 = Simonhöhe / 6 = Stelvio / 7 = Zermatt')
    ...
    with st.form("reg_form"):
        st.image('dashboard/Shapley_Values.png', width=700, caption='Shypley Values of Features')
